"""
Main settings file for the OpportunAI job tracker application.
"""
import os
...
DATABASES = {
    'default': {
        ...
        'NAME': os.environ.get('DB_NAME', 'opportunai'),
...
DEFAULT_FROM_EMAIL = os.environ.get('DEFAULT_FROM_EMAIL', 'noreply@opportunai.com')
...
LOGGING = {
    ...
    'handlers': {
        ...
        'file': {
            ...
            'filename': os.path.join(BASE_DIR, 'logs', 'opportunai.log'),
            'formatter': 'verbose',
        },
    },
    'loggers': {
